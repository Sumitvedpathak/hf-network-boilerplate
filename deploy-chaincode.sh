...
packageChaincode() {
    echo "===================== Creating Chaincode packaged on peer0.org1 ===================== "
    setGlobalsForPeer0Org1
    peer lifecycle chaincode package ./artifacts/src/fabcar/${CC_NAME}.tar.gz \
...
installChaincode() {
    ...
    setGlobalsForPeer0Org1
    peer lifecycle chaincode install ./artifacts/src/fabcar/${CC_NAME}.tar.gz
...
queryInstalled() {
    ...
    echo "===================== Successfully installed chaincode on channel for  peer0.org1.example.com ===================== "
}
...
approveForMyOrg1() {
    ...
    echo "===================== Chaincode approval received from org 1 ===================== "
...
approveForMyOrg2() {
    ...
    echo "===================== Chaincode approval received from org 2 ===================== "
}
...
commitChaincodeDefination() {
    ...
    echo "===================== Chaincode committed in all endorsing peers ===================== "
}
