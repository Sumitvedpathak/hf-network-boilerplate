...
export TEMP_FOLDER_PATH=../channel/app-ch/temp
...
export PEER0_ORG3_CA=${PWD}/../channel/app-ch/crypto-config/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/tls/ca.crt
...
setGlobalsForPeer0Org3() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/../channel/app-ch/crypto-config/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp
